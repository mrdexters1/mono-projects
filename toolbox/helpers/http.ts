...
export type HttpStatusOK = TS.ValuesOf<Pick<typeof HttpStatus, "OK" | "CREATED">>;
export type HttpStatusRedirect = TS.ValuesOf<
  Pick<typeof HttpStatus, "MOVED_PERMANENTLY" | "SEE_OTHER" | "TEMPORARY_REDIRECT">
>;
export type HttpStatusClientError = TS.ValuesOf<
  Pick<
    typeof HttpStatus,
    "BAD_REQUEST" | "UNAUTHORIZED" | "FORBIDDEN" | "NOT_FOUND" | "METHOD_NOT_ALLOWED" | "UNPROCESSABLE_CONTENT"
  >
>;
